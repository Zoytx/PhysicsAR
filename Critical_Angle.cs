...
public class Critical_Angle : MonoBehaviour
{
    ...
    public void increaseangle()
    {
...

        {
            ...
            spwn3.transform.rotation = Quaternion.Euler(90-change2, 90 - change, 0);
    ...
    public void increaseanglex()
    {
       ...
       
        {
            ...
            spwn3.transform.rotation = Quaternion.Euler(90-change, 90-change2, 0);
    ...
    public void decerase2()
    {
...

        {
            ...
            spwn2.transform.position -= new Vector3(0.0f, 0.05f, 0.00f);
            spwn3.transform.position -= new Vector3(0.0f, 0.05f, 0.00f);
...

            {
                ...
                if (fix == 0)
                {
                    if (spwn == null)
                    {
                        ...
                        Vector3 raypos = new Vector3(hitPose.position.x - 0.13f, hitPose.position.y-0.10f, hitPose.position.z - 0.1f);
                        Vector3 raypos2 = new Vector3(hitPose.position.x + 0.13f, hitPose.position.y - 0.10f, hitPose.position.z - 0.1f);
                    ...
                    {
                        hitPose.position.y += 0.2f;
                        Vector3 raypos = new Vector3(hitPose.position.x , hitPose.position.y - 0.10f, hitPose.position.z);
                        Vector3 raypos2 = new Vector3(hitPose.position.x , hitPose.position.y - 0.10f, hitPose.position.z );
